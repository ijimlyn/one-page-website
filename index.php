...
<head>
	...
	<script type="text/javascript" src="scripts/autopfefixer.js"></script><!--auto adds vendor prefixes-->
</head>
	
<body>
<header id="featured">
	<nav id="scrollspy-nav" class="navbar navbar-expand-md navbar-light bg-light fixed-top" ><!---->
		<div class="container">
			<a class="navbar-brand" href="#featured" >
				<h1>JIMLYN <span class="subhead">Web & Graphics</span></h1>
			</a>	
			...
			<div id="cDoctor" class="carousel cFade"> 
				...
				<div class="carousel-inner fullHeight">
					...
					<a class="carousel-control-next" href="#cDoctor" role="button" data-slide="next">
